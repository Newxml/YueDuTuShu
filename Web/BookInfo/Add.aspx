...
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:DropDownList ID="ddlType" runat="server" DataSourceID="SqlDataSource1" DataTextField="typeName" 
CssClass="form-control" Width="200px" DataValueField="typeId">
        </asp:DropDownList>
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:DropDownList ID="ddlBookCase" runat="server" DataSourceID="SqlDataSource2" DataTextField="caseName" CssClass="form-control" Width="200px" DataValueField="caseId">
        </asp:DropDownList>
