<%@ Page Title="Library" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="YueDuLibrary.Web.Library.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="libarayName" HeaderText="libarayName" SortExpression="libarayName" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="curator" HeaderText="curator" SortExpression="curator" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="tel" HeaderText="tel" SortExpression="tel" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Addresss" HeaderText="Addresss" SortExpression="Addresss" ItemStyle-HorizontalAlign="Center"  /> 
