<%@ Page Language="C#" MasterPageFile="~/YDLib.master" AutoEventWireup="true"
    CodeBehind="Add.aspx.cs" Inherits="YueDuLibrary.Web.Admin.Add" Title="增加页" %>
...
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
	...
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtadminName" runat="server" Width="200px" CssClass="form-control"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		登录密码
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtadminPass" runat="server" Width="200px" CssClass="form-control" TextMode="Password"></asp:TextBox>
